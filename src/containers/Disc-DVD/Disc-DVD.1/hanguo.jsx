...
import './css.less'
export default class Hanguo extends Component{
  render(){
    return (
      <div>
          <ul className="cvrlst">
            <li>
              ...
              <a href="/album?id=84698311" class="msk" title="Yummy"></a>
              <a href="javascript:;" class="icon-play f-alpha f-fr" title="播放" data-res-type="19" data-res-id="84698311" data-res-action="play"></a>
              </div>
